...
(use-package! exwm
  ...
  (setq exwm-randr-workspace-output-plist '(1 "DP-2" 4 "DP-4"))
  ...
  ;;  :map exwm-mode-map
  ;;  ;; :n "SPC" #'doom/leader
  ;;  ;; :n "i" #'my/exwm-enter-insert-state
  ;;  :localleader
  ;;  :desc "Toggle floating" "f" #'exwm-floating-toggle-floating
  ;;  :desc "Application" "a" #'counsel-linux-app
  ;;  )
